        ...
        <CardContent>
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm truncate">{settlement.supplierName || 'Unknown Supplier'}</span>
            </div>
            ...
            {((settlement.previousBalance !== undefined && settlement.previousBalance !== null && settlement.previousBalance !== 0) || 
             ...
             (settlement.poNumber && settlement.poNumber.trim() !== '') ||
      ...
      <Dialog open={showDeleteConfirmation} onOpenChange={setShowDeleteConfirmation}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete this supplier settlement? This action cannot be undone.
